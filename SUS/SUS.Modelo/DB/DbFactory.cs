...
using SUS.Modelo.DB.Repository;
using System;
...
namespace SUS.Modelo.DB
{
    public class DbFactory
    {
        ...
        private DbFactory()
        {
            ...
            VacinaRepository = new VacinaRepository(_sessionFactory);
            UsuarioRepository = new UsuarioRepository(_sessionFactory);
            CartaoVacinaRepository = new CartaoVacinaRepository(_sessionFactory);
